...
void main() {
  group('Pruebas con el decorador de baño Grupo1', () {
    ...
    test("Comprobación de que una casa no se puede crear sin Baño", () {
      ...
      casaDeCampoBuilder.setSalaDeEstar();
      casaDeCampoBuilder.setCocina();
      expect(() => casaDeCampoBuilder.setBanio(), throwsException);
    });

    test(
        'Comprobación de que todos los atributos estan instanciados, metodo toString de Casa',
        () {
      banio = BanioEstandar();
      banio = BanioConBidet(banio);
      banio = BanioConJacuzzi(banio);
  ...
  group('Pruebas con el decorador de cocina Grupo2', () {
    ...
    test(
        'Prueba de decorar una cocina de una casa de campo con tres lavavajillas',
        () {
      ...
      expect(
          casaDeCampoTresLavavajillas.toString(),
    ...
    test('Prueba de añadirle a una cocina multiples islas y lavavajillas', () {
      ...
      cocinaMultiplesDecorados =
          CocinaConLavavajillas(cocinaMultiplesDecorados);
      cocinaMultiplesDecorados = CocinaConIsla(cocinaMultiplesDecorados);
      cocinaMultiplesDecorados =
          CocinaConLavavajillas(cocinaMultiplesDecorados);
      cocinaMultiplesDecorados = CocinaConIsla(cocinaMultiplesDecorados);
      expect(cocinaMultiplesDecorados.toString(),
          "Cocina Con isla Con lavavajillas Con isla Con lavavajillas Con isla");
    });
  });
}
